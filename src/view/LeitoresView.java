...
import dao.LeitorDAO.EmailJaExisteException;
...
public class LeitoresView extends JPanel {
    ...
    private JPanel buildForm() {
        ...
        gc.gridx = 0;
        gc.gridy = y;
        form.add(new JLabel("Matrícula:"), gc);
        gc.gridx = 1;
        form.add(tfMat, gc);
        y++;
        ...
        gc.gridx = 0;
        gc.gridy = y;
        form.add(new JLabel("Telefone:"), gc);
        gc.gridx = 1;
        form.add(tfTel, gc);
        y++;
    ...
    private void addLeitor() {
        ...
        try {
            ...
            try {
                ...
                warn(ex.getMessage()); // mostra aviso na UI
            } catch (SQLException ex) {
